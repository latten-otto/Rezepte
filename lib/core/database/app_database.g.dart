    ...
    return IngredientsCompanion(
      ...
      category:
          category == null && nullToAbsent
              ...
              : Value(category),
      originalText:
          originalText == null && nullToAbsent
              ? const Value.absent()
              : Value(originalText),
...
class RecipeStep extends DataClass implements Insertable<RecipeStep> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, recipeId, stepNumber, instruction, imageUrl);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is RecipeStep &&
...
class MealPlanEntry extends DataClass implements Insertable<MealPlanEntry> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, mealPlanId, dayOfWeek, recipeId, isLocked, servings);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $ShoppingItemsTable extends ShoppingItems
  ...
  static const VerificationMeta _recipeIdsMeta = const VerificationMeta(
    'recipeIds',
  );
  @override
  ...
  ShoppingItem map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ShoppingItem(
      ...
      recipeIds:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}recipe_ids'],
          )!,
    );
  }
...
class UserPreferencesTableData extends DataClass
  ...
  final String key;
  final String value;
  const UserPreferencesTableData({required this.key, required this.value});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  UserPreferencesTableCompanion toCompanion(bool nullToAbsent) {
    return UserPreferencesTableCompanion(key: Value(key), value: Value(value));
  }
  ...
  UserPreferencesTableData copyWith({String? key, String? value}) =>
...
final class $$RecipesTableReferences
  ...
  _mealPlanEntriesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.mealPlanEntries,
    aliasName: $_aliasNameGenerator(db.recipes.id, db.mealPlanEntries.recipeId),
  );
...
typedef $$MealPlansTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (MealPlan, $$MealPlansTableReferences),
      MealPlan,
      PrefetchHooks Function({bool mealPlanEntriesRefs, bool shoppingItemsRefs})
    >;
...
final class $$MealPlanEntriesTableReferences
  ...
  static $RecipesTable _recipeIdTable(_$AppDatabase db) =>
      db.recipes.createAlias(
        $_aliasNameGenerator(db.mealPlanEntries.recipeId, db.recipes.id),
      );
